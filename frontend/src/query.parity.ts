...
export type QueryPublicSurfaceParity = [
  ...
  Assert<AssignableTo<typeof Rt.getField, typeof Pub.getField>>,
  Assert<AssignableTo<typeof Rt.getFields, typeof Pub.getFields>>,
  Assert<AssignableTo<typeof Rt.getFieldsByName, typeof Pub.getFieldsByName>>,
  Assert<AssignableTo<typeof Rt.getFieldBlocks, typeof Pub.getFieldBlocks>>,
  Assert<AssignableTo<typeof Rt.getBookmark, typeof Pub.getBookmark>>,
  Assert<AssignableTo<typeof Rt.getBookmarks, typeof Pub.getBookmarks>>,
  Assert<AssignableTo<typeof Rt.getFootnotes, typeof Pub.getFootnotes>>,
  Assert<AssignableTo<typeof Rt.getEndnotes, typeof Pub.getEndnotes>>,
  Assert<AssignableTo<typeof Rt.getListItems, typeof Pub.getListItems>>,
  Assert<AssignableTo<typeof Rt.getStyles, typeof Pub.getStyles>>,
  Assert<AssignableTo<typeof Rt.getStyleById, typeof Pub.getStyleById>>,
  Assert<AssignableTo<typeof Rt.blockPath, typeof Pub.blockPath>>,
