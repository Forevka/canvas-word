...
export function sampleDoc(): Document {
  ...
  const bodyBlocks: (Paragraph | TableBlock | ImageBlock | EquationBlock | ShapeBlock)[] = [
    ...
    para([
      ...
      run("grid-snap-off", { snapToGrid: false }), run(" run (w:snapToGrid), a "),
      run("French-tagged", { lang: { val: "fr-FR" } }), run(" run (w:lang), and "),
    ...
    para([run("The preset gallery — Lines, Basic Shapes (rectangle, rounded rectangle, ellipse, triangle, diamond, pentagon, hexagon, 5-point star, parallelogram, trapezoid) and Block Arrows (right/left/up/down), each with its own fill + outline:")], { spaceAfterPx: 4 }),
    ...
    shape("pentagon", 120, 100, "center", { color: "#d0e0e3" }, { color: "#134f5c", widthPt: 1.5 }),
    shape("hexagon", 140, 90, "center", { color: "#fff2cc" }, { color: "#bf9000", widthPt: 1.5 }),
    shape("star5", 120, 120, "center", { color: "#ffe599" }, { color: "#bf9000", widthPt: 1.5 }),
    shape("parallelogram", 150, 80, "left", { color: "#d9d2e9" }, { color: "#674ea7", widthPt: 1.5 }),
    shape("trapezoid", 150, 80, "left", { color: "#c9daf8" }, { color: "#3d85c6", widthPt: 1.5 }),
    ...
    shape("upArrow", 80, 120, "center", { color: "#d9ead3" }, { color: "#38761d", widthPt: 1.5 }),
    shape("downArrow", 80, 120, "center", { color: "#f4cccc" }, { color: "#cc4125", widthPt: 1.5 }),
