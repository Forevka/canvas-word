...
/** Register a bundled face's bytes (called by the measure host once per file). */
export function registerFont(file: string, bytes: Uint8Array): void {
...
/** Resolve a requested family+style to a loaded clone face. */
