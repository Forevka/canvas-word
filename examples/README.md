...
| [`custom-fonts`](./custom-fonts) | Supply your own fonts (`fonts`) — a self-hosted PT Serif (4 faces + sizing), hide a built-in, export with the font embedded | None (static HTML) |
