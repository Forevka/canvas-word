...
var builder = engine.NewBuilder(new CreateOptions { PageSize = PageSizeName.Letter })
    ...
    .Paragraph("Vector preset shapes (OOXML wps:wsp / a:prstGeom) round-trip losslessly to .docx. The widened preset gallery — Lines, Basic Shapes (rectangle, rounded rectangle, ellipse, triangle, diamond, pentagon, hexagon, 5-point star, parallelogram, trapezoid) and Block Arrows (right/left/up/down):")
    ...
    .Shape(ShapePreset.Pentagon, new ShapeOptions { WidthPx = 120, HeightPx = 100, Align = TextAlign.Center, Fill = ShapeFill.Solid("#d0e0e3"), Stroke = ShapeStroke.Solid("#134f5c", 1.5) })
    .Shape(ShapePreset.Hexagon, new ShapeOptions { WidthPx = 140, HeightPx = 90, Align = TextAlign.Center, Fill = ShapeFill.Solid("#fff2cc"), Stroke = ShapeStroke.Solid("#bf9000", 1.5) })
    .Shape(ShapePreset.Star5, new ShapeOptions { WidthPx = 120, HeightPx = 120, Align = TextAlign.Center, Fill = ShapeFill.Solid("#ffe599"), Stroke = ShapeStroke.Solid("#bf9000", 1.5) })
    .Shape(ShapePreset.Parallelogram, new ShapeOptions { WidthPx = 150, HeightPx = 80, Align = TextAlign.Left, Fill = ShapeFill.Solid("#d9d2e9"), Stroke = ShapeStroke.Solid("#674ea7", 1.5) })
    .Shape(ShapePreset.Trapezoid, new ShapeOptions { WidthPx = 150, HeightPx = 80, Align = TextAlign.Left, Fill = ShapeFill.Solid("#c9daf8"), Stroke = ShapeStroke.Solid("#3d85c6", 1.5) })
    ...
    .Shape(ShapePreset.UpArrow, new ShapeOptions { WidthPx = 80, HeightPx = 120, Align = TextAlign.Center, Fill = ShapeFill.Solid("#d9ead3"), Stroke = ShapeStroke.Solid("#38761d", 1.5) })
    .Shape(ShapePreset.DownArrow, new ShapeOptions { WidthPx = 80, HeightPx = 120, Align = TextAlign.Center, Fill = ShapeFill.Solid("#f4cccc"), Stroke = ShapeStroke.Solid("#cc4125", 1.5) })
